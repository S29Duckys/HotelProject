 ...
 <?php   foreach ($chambres ?? [] as $chambre) { ?>
        <div class="border border-slate-200 rounded-3xl overflow-hidden group hover:border-blue-400 transition-all">
            <div class="h-40 bg-slate-200 relative overflow-hidden">
                ...
                <span class="absolute top-4 left-4 px-3 py-1 bg-white/20 backdrop-blur-md border border-white/30 text-white text-[10px] font-black rounded-lg uppercase tracking-widest">--cat--</span>
                <div class="absolute bottom-4 left-4 text-white">
                    <h4 class="font-bold"><?= $chambre->getName() ?></h4>
                    <p class="text-[10px] opacity-80"><?= $chambre->getDescription() ?></p>
                </div>
            </div>
            <div class="p-5 flex justify-between items-center bg-white">
                <div>
                    ...
                    <p class="text-xl font-black text-slate-800"><?= $chambre->getPrix() ?></p>
                </div>
