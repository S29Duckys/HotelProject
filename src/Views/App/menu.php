...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-3 text-sm text-slate-400 font-medium">
        ...
        <span class="text-slate-700 font-bold">Menu du Terroir</span>
    </div>
    ...
    <div class="glass-card rounded-3xl p-8">
        <div class="flex items-start justify-between gap-6">
            <div class="flex items-center gap-5">
                ...
                <div>
                    <h2 class="text-2xl font-black text-slate-900">Menu du Terroir</h2>
                    <p class="text-sm text-slate-400 italic mt-1">Entrée + Plat + Dessert au choix parmi notre sélection de produits locaux et de saison.</p>
                </div>
            </div>
            <span class="text-3xl font-black text-blue-600 shrink-0">32,00 €</span>
        </div>
    </div>
    ...
    <div class="glass-card rounded-3xl p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="border border-slate-100 rounded-2xl p-5 hover:bg-slate-50 transition-colors">
                <div class="w-10 h-10 bg-emerald-500 text-white rounded-xl flex items-center justify-center font-black mb-3">R1</div>
                <p class="font-bold text-slate-800 text-sm">Le Grand Bistrot</p>
            </div>
    ...
    <div class="flex gap-3 justify-end">
        ...
        <button class="px-5 py-2.5 rounded-xl text-sm font-bold bg-slate-100 text-slate-700 hover:bg-slate-200 transition-colors">
            <i class="fas fa-pen mr-2"></i> Modifier
        </button>
        <button class="px-5 py-2.5 rounded-xl text-sm font-bold bg-red-500 text-white shadow-lg shadow-red-200 hover:scale-105 transition-transform">
